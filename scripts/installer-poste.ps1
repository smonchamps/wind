...
Write-Host "  1. Identifiants OAuth au niveau utilisateur -- geste de POSTE DEV seulement"
Write-Host "     (une release publique embarque les siens au build, D1 PLAN-RETOURS-9 ;"
Write-Host "     ces variables restent necessaires pour un build dev et pour faire-release.ps1"
Write-Host "     qui les mappe vers WIND_RELEASE_*) -- valeurs a reprendre de la machine actuelle :"
