...
// surface, encre). Les mêmes valeurs vivent en jetons dans systeme.css :
// les pastilles doivent montrer chaque thème SANS l'appliquer, d'où les
// hex répétés ici. Libellés et descriptions vivent au catalogue
// (`theme.<id>.nom` / `theme.<id>.desc` — PLAN-LANGUES, A15).
export const FICHES = [
  { id: 'air', pastilles: ['#3a7aa1', '#eef2f5', '#e3e9ee', '#ffffff', '#22303a'] },
  { id: 'feu', pastilles: ['#c0492b', '#f5efe8', '#eee3d9', '#fffaf5', '#2d201b'] },
