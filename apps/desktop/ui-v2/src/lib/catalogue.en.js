...
export const EN = {
  ...
  'boite.feed': 'Feed',
  'boite.paper_trail': 'Paper trail',
  'boite.screener': 'Screener',
  'boite.sent': 'Sent',
  'boite.drafts': 'Drafts',
  'boite.junk': 'Junk',
  'boite.archive': 'Archives',
  'boite.trash': 'Trash',
  ...
  'toast.expediteurDeplace': 'Sender moved to {mailbox}: their messages follow.',
  ...
  'toast.portierOuiVers': '{qui} can write to you: their messages go to {mailbox}.',
  ...
  'liste.deplacerVers': 'Move to {mailbox}',
  ...
  'statut.categorie': '{mailbox} · {n} item|{mailbox} · {n} items',
  ...
  'statut.pourcent': '{p}%',
  'statut.phase.inventory': 'folder inventory',
  'statut.phase.threads': 'conversation threads',
  'statut.phase.drafts': 'drafts',
  ...
  // --- Fente d'avis -----------------------------------------------------
  'avis.envoiRefuse': 'The message “{subject}” was rejected{erreur}.',
  'avis.envoiInterrompu': 'The message “{subject}” was interrupted{erreur}.',
  ...
  'avis.programme': '“{subject}” will be sent {quand}, if Wind is open at that time.',
  ...
  'inv.vous_accepted': 'You accepted',
  'inv.vous_tentative': 'You tentatively accepted',
  'inv.vous_declined': 'You declined',
  'inv.repondant_accepted': '{qui} accepted',
  'inv.repondant_tentative': '{qui} tentatively accepted',
  'inv.repondant_declined': '{qui} declined',
  'inv.repondant_no_reply': '{qui} replied',
  'inv.annuleeTexte': 'The meeting was cancelled by the organiser.',
  'inv.lieuOrganisateur': '{location} · organised by {qui}',
  'inv.organisePar': 'Organised by {qui}',
  'inv.seRepete': 'repeats',
  'inv.heureLocale': 'organiser’s local time',
  'inv.sujet_accepted': 'Accepted: {title}',
  'inv.sujet_tentative': 'Tentative: {title}',
  'inv.sujet_declined': 'Declined: {title}',
  'inv.puce_accepted': 'Accepted',
  'inv.puce_tentative': 'Tentative',
  'inv.puce_declined': 'Declined',
  ...
  'erreur.groupePartiel': '{done} of {total}; the rest failed.',
  ...
  'repere.teinte.red': 'Red',
  'repere.teinte.orange': 'Orange',
  'repere.teinte.ochre': 'Ochre',
  'repere.teinte.olive': 'Olive',
  'repere.teinte.green': 'Green',
  'repere.teinte.pine': 'Pine',
  'repere.teinte.blue': 'Blue',
  'repere.teinte.indigo': 'Indigo',
  'repere.teinte.violet': 'Purple',
  'repere.teinte.magenta': 'Magenta',
  'repere.teinte.pink': 'Pink',
  'repere.teinte.brown': 'Brown',

  'compo.nouveau': 'New message',
  'compo.re': 'Re: {subject}',
  'compo.tr': 'Fwd: {subject}',
  ...
  'compo.retirerPiece': 'Remove {name}',
  'compo.rapatriement': '{name} · retrieving…',
  'compo.poidsTotal': '{poids} / 25 MB',
  'compo.pieceRefusee': '"{name}" exceeds the remaining space ({reste}).',
  ...
  'nettoyage.perimetre.inbox': 'Inbox only',
  'nettoyage.perimetre.folders': 'Inbox + Folders',
  'nettoyage.perimetre.foldersArchive': 'Inbox + Folders + Archive',
  'nettoyage.perimetre.archive': 'Inbox + Archive',
