...
export const FR = {
  ...
  'boite.inbox': 'Boîte de réception',
  ...
  'boite.feed': 'Kiosque',
  'boite.paper_trail': 'Registre',
  'boite.screener': 'Portier',
  'boite.sent': 'Envoyés',
  'boite.drafts': 'Brouillons',
  'boite.junk': 'Indésirables',
  'boite.archive': 'Archives',
  'boite.trash': 'Corbeille',
  ...
  'toast.expediteurDeplace': 'Expéditeur déplacé vers {mailbox} : ses messages suivent.',
  ...
  'toast.portierOuiVers': '{qui} peut vous écrire : ses messages vont vers {mailbox}.',
  ...
  'liste.deplacerVers': 'Déplacer vers {mailbox}',
  ...
  'statut.categorie': '{mailbox} · {n} élément|{mailbox} · {n} éléments',
  ...
  'statut.pourcent': '{p} %',
  'statut.phase.inventory': 'inventaire des dossiers',
  'statut.phase.threads': 'fils de discussion',
  'statut.phase.drafts': 'brouillons',
  ...
  // --- Fente d'avis -----------------------------------------------------
  'avis.envoiRefuse': "L'envoi « {subject} » a été refusé{erreur}.",
  'avis.envoiInterrompu': "L'envoi « {subject} » a été interrompu{erreur}.",
  ...
  'avis.programme': '« {subject} » partira {quand}, si Wind est ouvert à ce moment-là.',
  ...
  'inv.vous_accepted': 'Vous avez accepté',
  'inv.vous_tentative': 'Vous avez répondu provisoirement',
  'inv.vous_declined': 'Vous avez refusé',
  'inv.repondant_accepted': '{qui} a accepté',
  'inv.repondant_tentative': '{qui} a répondu provisoirement',
  'inv.repondant_declined': '{qui} a refusé',
  'inv.repondant_no_reply': '{qui} a répondu',
  'inv.annuleeTexte': 'La réunion a été annulée par l’organisateur.',
  'inv.lieuOrganisateur': '{location} · organisé par {qui}',
  'inv.organisePar': 'Organisé par {qui}',
  'inv.seRepete': 'se répète',
  'inv.heureLocale': 'heure locale de l’organisateur',
  'inv.sujet_accepted': 'Accepté : {title}',
  'inv.sujet_tentative': 'Provisoire : {title}',
  'inv.sujet_declined': 'Refusé : {title}',
  'inv.puce_accepted': 'Acceptée',
  'inv.puce_tentative': 'Provisoire',
  'inv.puce_declined': 'Refusée',
  ...
  'erreur.groupePartiel': '{done} sur {total} ; le reste a échoué.',
  ...
  'repere.teinte.red': 'Rouge',
  'repere.teinte.orange': 'Orange',
  'repere.teinte.ochre': 'Ocre',
  'repere.teinte.olive': 'Olive',
  'repere.teinte.green': 'Vert',
  'repere.teinte.pine': 'Sapin',
  'repere.teinte.blue': 'Bleu',
  'repere.teinte.indigo': 'Indigo',
  'repere.teinte.violet': 'Violet',
  'repere.teinte.magenta': 'Magenta',
  'repere.teinte.pink': 'Rose',
  'repere.teinte.brown': 'Brun',
  ...
  'compo.retirerPiece': 'Retirer {name}',
  'compo.rapatriement': '{name} · rapatriement…',
  'compo.poidsTotal': '{poids} / 25 Mo',
  'compo.pieceRefusee': '« {name} » dépasse la place restante ({reste}).',
  ...
  'boite.cleanup': 'Nettoyage de printemps',
  'nettoyage.sousTitre':
  ...
  'nettoyage.perimetre.inbox': 'Réception seule',
  'nettoyage.perimetre.folders': 'Réception + Dossiers',
  'nettoyage.perimetre.foldersArchive': 'Réception + Dossiers + Archives',
  'nettoyage.perimetre.archive': 'Réception + Archives',
